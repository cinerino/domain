...
}): factory.order.IAcceptedOffer<factory.paymentMethod.paymentCard.prepaidCard.IPrepaidCard>[] {
    const acceptedOffers: factory.order.IAcceptedOffer<factory.paymentMethod.paymentCard.prepaidCard.IPrepaidCard>[] = [];
